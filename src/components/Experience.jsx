    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-[2px] bg-neutral-800" />
          ...
          <div className="flex flex-col gap-16">
            {experiences.map((exp, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-[#111111] border border-neutral-800 rounded-xl shadow-sm p-6">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-neutral-400">{exp.time}</p>
                      </div>
                    </div>

                    <div className="space-y-2 text-neutral-300 text-[15px] leading-relaxed text-justify">
